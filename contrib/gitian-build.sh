...
DEFAULT_GAIA_SIGS=${GAIA_SIGS:-'hashgard.sigs'}
DEFAULT_GITIAN_REPO='https://github.com/devrandom/gitian-builder'
DEFAULT_GBUILD_FLAGS=''
DEFAULT_SIGS_REPO='https://github.com/hashgard/hashgard.sigs'
...
f_build() {
  ...
  bin/gbuild --commit hashgard="$g_commit" ${GBUILD_FLAGS} "$l_descriptor"
