...
import (
	...
	hashgard "github.com/hashgard/hashgard/app"
)
...
func runHackCmd(cmd *cobra.Command, args []string) error {
	...
	db, err := sdk.NewLevelDB("hashgard", dataDir)
	if err != nil {
		fmt.Println(err)
		os.Exit(1)
	}
	app, keyMain, keyStaking, stakingKeeper := hashgard.NewHashgardAppUNSAFE(
