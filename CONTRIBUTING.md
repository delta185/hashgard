...
Thank you for considering making contributions to Hashgard and related
repositories!
...
1. Either [open](https://github.com/hashgard/hashgard/issues/new/choose) or
   [find](https://github.com/hashgard/hashgard/issues) an issue you'd like to help with
...
Other notes:
  - Looking for a good place to start contributing? How about checking out some
    [good first issues](https://github.com/hashgard/hashgard/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
...
If you open a PR in Hashgard, it is mandatory to update the relevant documentation in /docs.

* If your changes relate specifically to the hashgard application, please modify the docs/ folder.

## Forking

Please note that Go requires code to live under absolute paths, which complicates forking.
While my fork lives at `https://github.com/rigeyrigerige/hashgard`,
the code should never exist at  `$GOPATH/src/github.com/rigeyrigerige/hashgard`.
Instead, we use `git remote` to add the fork as a new remote for the original repo,
`$GOPATH/src/github.com/hashgard/hashgard `, and do all the work there.

For instance, to create a fork and work on a branch of it, I would:

  - Create the fork on github, using the fork button.
  - Go to the original repo checked out locally (i.e. `$GOPATH/src/github.com/hashgard/hashgard`)
  - `git remote rename origin upstream`
  - `git remote add origin git@github.com:rigeyrigerige/hashgard.git`

Now `origin` refers to my fork and `upstream` refers to the Hashgard version.
So I can `git push -u origin master` to update my fork, and make pull requests to Hashgard from there.
...
The master branch of every Hashgard repository should just build with `go get`,
...
Hashgard utilizes [semantic versioning](https://semver.org/).
...
### Development Procedure
  ...
  - create a development branch either on github.com/hashgard/hashgard, or your fork (using `git remote add origin`)
