...
import (
	"github.com/cosmos/cosmos-sdk/x/grid999"
	"github.com/cosmos/cosmos-sdk/x/migrate"
...
const appName = "HashgardApp"

var (
	// default home directories for hashgardcli
	DefaultCLIHome = os.ExpandEnv("$HOME/.hashgardcli")

	// default home directories for hashgardd
	...
	ModuleBasics = module.NewBasicManager(
		...
		// HashGard
		scene.AppModuleBasic{},
		migrate.AppModuleBasic{},
		grid999.AppModuleBasic{},
	)
	...
	maccPerms = map[string][]string{
		...
		// HashGard
		migrate.ModuleName: {supply.Minter},
	}
)
...
type HashgardApp struct {
	*bam.BaseApp
	...
	// keepers
	// HashGard
	sceneKeeper    *scene.Keeper
	migrateKeeper  migrate.Keeper
	grid999Keeper  grid999.Keeper
...
func NewHashgardApp(logger log.Logger, db dbm.DB, traceStore io.Writer, loadLatest bool,
	invCheckPeriod uint, baseAppOptions ...func(*bam.BaseApp)) *HashgardApp {
	...
	keys := sdk.NewKVStoreKeys(
		...
		// HashGard
		scene.StoreKey, migrate.StoreKey, grid999.StoreKey,
	)
	...
	app.mm = module.NewManager(
		...
		// HashGard
		scene.NewAppModule(*app.sceneKeeper),
		migrate.NewAppModule(app.migrateKeeper),
		grid999.NewAppModule(app.grid999Keeper),
	)
	...
	app.mm.SetOrderEndBlockers(crisis.ModuleName, gov.ModuleName, staking.ModuleName, auth.ModuleName) // HashGard
	...
	app.mm.SetOrderInitGenesis(
		...
		mint.ModuleName, supply.ModuleName, crisis.ModuleName, genutil.ModuleName, scene.ModuleName, migrate.ModuleName, grid999.ModuleName, //HashGard
	)
	...
	app.SetSceneKeeper(app.sceneKeeper)
...
func (app *HashgardApp) ModuleAccountAddrs() map[string]bool {
