...
func getSimulateFromSeedInput(tb testing.TB, w io.Writer, app *HashgardApp) (
...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/cosmos/cosmos-sdk/HashgardApp -bench ^BenchmarkFullAppSimulation$ -Commit=true -cpuprofile cpu.out
